...
public class Receiver extends Thread {
	...
	private List<String> allCargos = Collections.synchronizedList(new ArrayList<>()); // Threadsichere Liste
	private List<String> allHarbours = Collections.synchronizedList(new ArrayList<>()); // Threadsichere Liste
